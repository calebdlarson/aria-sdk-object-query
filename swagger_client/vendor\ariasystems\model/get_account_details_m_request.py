...
class GetAccountDetailsMRequest(object):
    ...
    def __init__(self, rest_call='get_account_details_m', release_version='23', output_format='json', client_no=None, auth_key=None, limit=None, offset=None, query_string=None):  # noqa: E501
        """GetAccountDetailsMRequest - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def rest_call(self):
        """Gets the rest_call of this GetAccountDetailsMRequest.  # noqa: E501


        :return: The rest_call of this GetAccountDetailsMRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def rest_call(self, rest_call):
        """Sets the rest_call of this GetAccountDetailsMRequest.


        :param rest_call: The rest_call of this GetAccountDetailsMRequest.  # noqa: E501
        :type: str
        """
        if rest_call is None:
            raise ValueError("Invalid value for `rest_call`, must not be `None`")  # noqa: E501
        allowed_values = ["get_account_details_m"]  # noqa: E501
    ...
    def release_version(self):
        """Gets the release_version of this GetAccountDetailsMRequest.  # noqa: E501


        :return: The release_version of this GetAccountDetailsMRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def release_version(self, release_version):
        """Sets the release_version of this GetAccountDetailsMRequest.


        :param release_version: The release_version of this GetAccountDetailsMRequest.  # noqa: E501
        :type: str
        """
    ...
    def output_format(self):
        """Gets the output_format of this GetAccountDetailsMRequest.  # noqa: E501


        :return: The output_format of this GetAccountDetailsMRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def output_format(self, output_format):
        """Sets the output_format of this GetAccountDetailsMRequest.


        :param output_format: The output_format of this GetAccountDetailsMRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def client_no(self):
        """Gets the client_no of this GetAccountDetailsMRequest.  # noqa: E501

        Aria-assigned unique identifier indicating the Aria client providing service to this account.   # noqa: E501

        :return: The client_no of this GetAccountDetailsMRequest.  # noqa: E501
        :rtype: int
        """
    ...
    def client_no(self, client_no):
        """Sets the client_no of this GetAccountDetailsMRequest.

        Aria-assigned unique identifier indicating the Aria client providing service to this account.   # noqa: E501

        :param client_no: The client_no of this GetAccountDetailsMRequest.  # noqa: E501
        :type: int
        """
    ...
    @property
    def auth_key(self):
        """Gets the auth_key of this GetAccountDetailsMRequest.  # noqa: E501

        Aria-assigned unique key to be passed with each method call for authenticating the validity of the requestor.   # noqa: E501

        :return: The auth_key of this GetAccountDetailsMRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def auth_key(self, auth_key):
        """Sets the auth_key of this GetAccountDetailsMRequest.

        Aria-assigned unique key to be passed with each method call for authenticating the validity of the requestor.   # noqa: E501

        :param auth_key: The auth_key of this GetAccountDetailsMRequest.  # noqa: E501
        :type: str
        """
        if auth_key is None:
    ...
    @property
    def limit(self):
        """Gets the limit of this GetAccountDetailsMRequest.  # noqa: E501
        ...
        :return: The limit of this GetAccountDetailsMRequest.  # noqa: E501
        :rtype: int
        """
        return self._limit
    ...
    def limit(self, limit):
        """Sets the limit of this GetAccountDetailsMRequest.

        The maximum number of objects to be returned by this call. Note that Aria recommends a maximum limit  of less than 1,000. Higher limits may take much longer to return data. If you do not specify a value,  or specify a value of \"0\", this field defaults to 100. Specifying a value of \"-1\" returns a count of  the number of matching records, but does not return any records.   # noqa: E501

        :param limit: The limit of this GetAccountDetailsMRequest.  # noqa: E501
        :type: int
        """
    ...
    @property
    def offset(self):
        """Gets the offset of this GetAccountDetailsMRequest.  # noqa: E501

        The number of records to skip. Note that both \"0\" and NULL will cause the interface not to skip any records.   # noqa: E501

        :return: The offset of this GetAccountDetailsMRequest.  # noqa: E501
        :rtype: int
        """
        return self._offset
    ...
    def offset(self, offset):
        """Sets the offset of this GetAccountDetailsMRequest.

        The number of records to skip. Note that both \"0\" and NULL will cause the interface not to skip any records.   # noqa: E501

        :param offset: The offset of this GetAccountDetailsMRequest.  # noqa: E501
        :type: int
        """
    ...
    def query_string(self):
        """Gets the query_string of this GetAccountDetailsMRequest.  # noqa: E501
        ...
        :return: The query_string of this GetAccountDetailsMRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def query_string(self, query_string):
        """Sets the query_string of this GetAccountDetailsMRequest.

        The criteria which all returned objects must match. Different objects have a different set of searchable criteria. Fields marked with \"*Query\" in the returns section can be used as part of the query_string. Valid operations for the query string include \"=\", \"!=\", \"<\", \"<=\", \">=\", \">\", \"IS NULL\", \"IS NOT NULL\", \"LIKE\", and \"NOT LIKE\". You must leave a space before and after each operation. The first operand must always be a field name, and the second operand must always be a value (except for \"IS NULL\" and \"IS NOT NULL\", where the second operand is implicitly \"NULL\"). If the second operand contains a space, less than, greater than, or equals sign, then it must be enclosed in double quotes. The second operand may not contain double quotes. Multiple conditions must be joined with either \"AND\" or \"OR\". Additionally, any queryable field can also be used to order the results, by appending \"ORDER BY\" to the query, followed by a field name and either \"ASC\" or \"DESC\".   # noqa: E501

        :param query_string: The query_string of this GetAccountDetailsMRequest.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetAccountDetailsMRequest):
            return False
