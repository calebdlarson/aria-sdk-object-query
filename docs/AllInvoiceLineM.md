...
**credit_reason_code_description** | **str** |  | [optional] 
...
**plan_instance_no** | **int** | Aria-assigned unique identifier of the plan instance directly associated  with this invoice line item. Note that this parameter may be a master plan  instance or a supplemental plan instance.  | [optional] 
**client_plan_instance_id** | **str** | Client-defined unique identifier of the plan instance directly associated  with this invoice line item. Note that this parameter may be a master plan instance  or a supplemental plan instance.  | [optional] 
